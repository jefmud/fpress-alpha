########### Flaskpress forms
## I adopted most of this file from one of my other projects
## you will find some unused stuff in here until it is refactored.
from flask import g
...
class CSRF(FlaskForm):
    ...
    # rather than reinventing the wheel, use FlaskWTF CSRF
    # CSRF = cross site request forgery (high-entropy protection)
    pass
